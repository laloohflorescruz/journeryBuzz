...
function ReviewsByTours() {
  ...
  const reviews: Review[] = [
    { id: 1, customerName: 'Juan Pérez', tourOrItinerary: 'Tour por Madrid Centro', rating: 5, comment: 'Excelente tour, muy bien organizado y divertido.', date: '2024-07-16' },
    { id: 2, customerName: 'Maria Lopez', tourOrItinerary: 'Tour Gaudí Barcelona', rating: 4, comment: 'Muy interesante, el guía fue muy amable.', date: '2024-07-21' },
    { id: 3, customerName: 'Carlos García', tourOrItinerary: 'Tour Roma Antigua', rating: 3, comment: 'Buena experiencia, pero un poco cansado.', date: '2024-08-02' },
    { id: 4, customerName: 'Ana Martínez', tourOrItinerary: 'Tour París Iluminado', rating: 5, comment: 'Hermosas vistas y excelente guía.', date: '2024-08-11' },
    { id: 5, customerName: 'Luis Fernández', tourOrItinerary: 'Tour Amsterdam Canales', rating: 4, comment: 'Muy relajante y bien organizado.', date: '2024-08-16' },
    { id: 6, customerName: 'Elena Ruiz', tourOrItinerary: 'Tour por Madrid Centro', rating: 4, comment: 'Gran experiencia, recomendado.', date: '2024-08-20' },
    { id: 7, customerName: 'Pedro Sánchez', tourOrItinerary: 'Tour Gaudí Barcelona', rating: 5, comment: 'Increíble, volvería a hacerlo.', date: '2024-08-25' },
  ];
